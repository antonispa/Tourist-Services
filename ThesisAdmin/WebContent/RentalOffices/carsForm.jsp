	...
	<div class="contentFrame">
		<form action="/ThesisAdmin/DbConnect" method="post">
			...
			<br>
				...
				Car cc: <br> <input type="text" name="carCc"><br><br>
				Passengers: <br> <input type="text" name="passengers"><br><br>
				Category: <br> <input type="text" name="carCategory"><br><br>
				<input type="submit" value="insert" name="carButton">
			</fieldset>
		</form>
	</div>
	<br><br>
	<iframe src="carsManagement.html" class="contentFrame">
