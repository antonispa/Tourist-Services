...
function activeTab(){
	...
	document.getElementById("carbookings").className = "navColor";
};
</script>
<script>
	function clickFunc(){
		document.getElementById("carBookingsBtn").click();
	}
</script>
<style>
	#carBookingsBtn {
...
<body onload="activeTab(); clickFunc();">
	...
	<form action="/ThesisAdmin/DbConnect" method="post" target="manageFrame">
		<input type="submit" value="" id="carBookingsBtn" name="carBookingsBtn">
	</form>
