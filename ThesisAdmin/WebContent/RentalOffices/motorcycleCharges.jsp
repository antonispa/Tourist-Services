...
<script type="text/javascript">
	$(document).ready(function(){
			...
			$(motorcycleCharges).addClass("navColor");			
	});
</script>
</head>
<body>
	...
	<div class="contentFrame">
		<form action="/ThesisAdmin/DbConnect" method="post">
			...
			<br>
				...
				Motorcycle id: <br> <input type="text" name="motorId"><br><br>
				Days: <br> <input type="text" name="days"><br><br>
				Charge: <br> <input type="number" name="charge"><br><br>
				<input type="submit" value="insert" name="motorChargesBtn">
			</fieldset>
		</form>
	</div>
	<br><br>
	<iframe src="motorChargesMan.html" class="contentFrame">
