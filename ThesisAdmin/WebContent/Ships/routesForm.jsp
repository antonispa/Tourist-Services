	...
	<div class="contentFrame">
		<form action="/ThesisAdmin/DbConnect" method="post">
			<fieldset style="height: auto">
				...
				Ship ID: <br> <input type="text" name="shipID"></input><br><br>
				Route ID: <br> <input type="text" name="routeID"></input><br><br>
				...
				<input type="submit" value="insert" name="shipRouteButton">
			</fieldset>
		</form>
		<br><br><br><br>
	</div>		
	
	<iframe src="routesManage.html" class="contentFrame" name="contentFrame">
