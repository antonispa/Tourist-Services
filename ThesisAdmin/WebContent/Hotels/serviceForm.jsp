...
<script>
	function activeTab(){
		...
		document.getElementById("services").className = 'navColor';
	};
</script>
</head>
	...
	<div class="contentFrame">
		<form action="/ThesisAdmin/DbConnect" method="post">
			<fieldset style="height: auto">
				...
				Services:<br><br>
				<input type="checkbox" name="wifiBox">Wifi<br> 
				<input type="checkbox" name="balconyBox">Balcony<br> 
				<input type="checkbox" name="seaviewBox">Sea view<br><br>
				<input type="submit" value="insert" name="servicesButton">
			</fieldset>
		</form>
	</div>
	<br><br>
	<iframe src="servicesManagement.html" class="contentFrame" name="manageFrame">
