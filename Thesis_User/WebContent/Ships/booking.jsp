...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <script>
	$(document).ready(function(){
			$(ships).css("background-color","#CD5C5C");
	});
</script>
<style>
...
%>
	...
	<div class="container">
		...
		<form class="form-horizontal" action="../../Thesis_User/ShipsThanksPage" method="post">
		
			<div class="form-group">
				<input class="form-control" style="border: none"  type="hidden" value="<%= company_name %>" name="company_name"/> 
				<input class="form-control" style="border: none"  type="hidden" value="<%= ship_id %>" name="ship_id"/> 
				<input class="form-control" style="border: none"  type="hidden" value="<%= route_id %>" name="route_id"/> 
			...
			<div class="col-sm-offset-5 col-md-offset-2">
				<button type="submit" class="btn btn-info" name="booknow_ship">Book Now</button>
			</div>
		</form>
	</div>
