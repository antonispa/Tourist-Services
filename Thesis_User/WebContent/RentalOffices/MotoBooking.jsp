	...
	<div class="container">
		...
		<form class="form-horizontal" action="../RentalsThanksPage" method="post">
			...
			<div class="form-group">
				...
				<input class="form-control" style="border: none"  type="hidden" value="<%= motor_id %>" name="motor_id"/>
			...
			<div class="col-sm-offset-5 col-md-offset-2">
				<button type="submit" class="btn btn-info" name="booknow_motor">Book Now</button>
			</div>
		</form>
	</div>
